####################
#slight modifications for the required application, modified from the code and propert located at the repo https: //github.com/tonbut/RPiSpectrometer
############
import sys
import math
import time
...
import OrderedDict
from PIL
import Image, ImageDraw, ImageFile, ImageFont
...
#
return an RGB visual representation of wavelength
for chart# Based on: http: //www.efg2.com/Lab/ScienceAndEngineering/Spectra.htm
  #The foregoing is based on: http: //www.midnightkite.com/color.html
  #thresholds = [380, 440, 490, 510, 580, 645, 780]# vio blu cyn gre yel org red
...
print("ideal exposure between 1 and 6")
print("exposure=", exposure)
if exposure < 1:
  print("increase shutter time parameter")
elif exposure > 6:
  print("reduce shutter time parameter")
...
f1 = 1.0 / w1
f2 = 1.0 / w2
for x in range(0, w, 1): #Iterate across frequencies, not wavelengths
...
for wavelength in normalized_results:
  wl = float(wavelength)
x = int((wl - w1) / (w2 - w1) * w)# print wavelength, x
